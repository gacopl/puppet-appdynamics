...
(
  ...
  String $agent_base = $appdynamics::agent::database::agent_base,
  String $agent_installer = $appdynamics::agent::database::agent_installer,
  String $s3_bucket_name = $appdynamics::agent::database::s3_bucket_name,
  String $s3_bucket_folder = $appdynamics::agent::database::s3_bucket_folder,
  String $agent_home = $appdynamics::agent::database::agent_home,
  String $service_name = $appdynamics::agent::database::service_name,
) {
